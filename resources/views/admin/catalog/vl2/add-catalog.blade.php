          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm danh mục cấp 2</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('danh-muc-cap-2.store')}}" method="post" enctype="multipart/form-data">
              @csrf
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control  @foreach($errors->get('name') as $err){{$err}} @endforeach" placeholder="Tên Danh Mục Cấp 2">
                  </div>
                </div>
                <!-- /.card-body -->
